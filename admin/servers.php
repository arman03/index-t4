  ...
  <div id="server">
    ...
    <div id="tabs-9">
      ...
      <p>
        ...
        <input name="name9" type="text" id="name9" value="<?php echo $server_nine_name ?>">
      </p>
      <p>
        <label for="link9">لینک:</label>
        <input name="link9" type="text" id="link9" value="<?php echo $server_nine_link ?>">
      </p>
      <p> سرعت
        <label for="speed9">:</label>
        <input name="speed9" type="text" id="speed9" value="<?php echo $server_nine_speed ?>">
      </p>
      <p>
        <label>ورژن :
          <input name="version9" type="radio" id="version9" value="3" <?php if($server_nine_version == 3){ ?> checked <?php } ?>>
          3</label>
        <label>
      ...
      <p>
        <label> جایزه :
          <input name="prize9" type="radio" id="prize9" value="true" <?php if($server_nine_reward){ ?> checked <?php } ?>>
          دارد</label>
        <label>
          <input type="radio" name="prize9" value="false" id="prize9" <?php if(!$server_nine_reward){ ?> checked <?php } ?>>
          ندارد</label>
        <br>
      </p>
    </div>
